...
form#curriculo(action="")
  fieldset
    legend.animate_intro Dados pessoais

    // Get the name
    label(for="GET-name").animate_intro
      p.text Nome completo:
    ...
    p.animate_intro Disponibilidade para viagens:
